    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md">
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-xl">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            <li>• Name :  [Avadhesh Kumar Shah]</li>
            <li>• Contact : 6263165747</li>
          <li>• Email : avadheshkumarshah578@gmail.com</li>
          <li>• GitHub : <a href="https://github.com/avadheshgithub/" className="underline">https://github.com/avadheshgithub/</a></li>
          </ul>
        </div>
      </div>
    </div>
